...
class VidaGSPOReward(ORM):
    ...
    def __call__(self, completions: List[str], **kwargs) -> List[float]:
        ...
        Args:
            ...
            **kwargs: 包含数据集的其他列，例如 kwargs['label']
        """
        rewards = []
        ...
        if not labels:
            print(f">> [Warning] 'label' not found in kwargs. Keys: {kwargs.keys()}")
        ...
        return rewards
if 'vida_gspo_reward' not in orms:
    orms['vida_gspo_reward'] = VidaGSPOReward

print(">> [Plugin] Class 'VidaGSPOReward' updated and registered.")